...
public class BinarySearchTree<E extends Comparable<E>> {
    ...
    protected class RecBST {
        ...
        protected int computeHeight() {
            ...
            if(right == null) return left.computeHeight() + 1;
            if(left == null) return right.computeHeight() + 1;

            return Math.max(left.computeHeight(), right.computeHeight()) + 1;
        }
        ...
        protected boolean insert(E label) {
            if(label.compareTo(this.label) == 0) return false;
        ...
        protected void addLabelsInOrder(List<E> l) {
            if(left != null) left.addLabelsInOrder(l);
            l.add(label);
            if(right != null) right.addLabelsInOrder(l);
        }
        ...
        protected List<E> inOrderVisit() {
            ...
            if(left != null) left.inOrderVisit();
            list.add(label);
            if(right != null) right.inOrderVisit();
            return list;
        }
        ...
        protected RecBST getMaxNode() {
            if(right != null) return right.getMaxNode();
            return this;
        }
